...
class _MyHomePageState extends State<MyHomePage> {
  String creatureSearchName = "";

  void _onSearchTextChanged(String newText){
    setState(() {
      creatureSearchName = newText;
    });
  }

  void _searchForCreatures() {
    apiClient.searchCreatures(creatureName: creatureSearchName).then((value) => print(creatureSearchResultToJson(value)));
  }
